...
/**
 * Utilities for the {@value JinahyaARIAUtils#ALGORITHM} algorithm.
 *
...
public final class JinahyaARIAUtils {
    ...
    /**
     * The block size of the {@value JinahyaARIAUtils#ALGORITHM} algorithm. The value is {@value}.
     *
     * @see #BLOCK_BYTES
     */
    ...
    /**
     * The block size, in bytes, of the {@value JinahyaARIAUtils#ALGORITHM} algorithm. The value is {@value}.
     *
     * @see #BLOCK_SIZE
     */
