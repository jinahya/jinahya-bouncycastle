...
@Disabled("Partial blocks not supported")
class JinahyaBufferedBlockCipherCrypto_KXTS_Test
    ...
    static Stream<Arguments> getCipherAndParamsArgumentsStream() {
        return JinahyaBufferedBlockCipherUtils_KXTS_Test.getCipherAndParamsArgumentsStream();
    }

    JinahyaBufferedBlockCipherCrypto_KXTS_Test() {
