...
class JinahyaBufferedBlockCipherCrypto_CTS_Test
    ...
    static Stream<Arguments> getCipherAndParamsArgumentsStream() {
        return JinahyaBufferedBlockCipherUtils_CTS_Test.getCipherAndParamsArgumentsStream();
    }

    JinahyaBufferedBlockCipherCrypto_CTS_Test() {
