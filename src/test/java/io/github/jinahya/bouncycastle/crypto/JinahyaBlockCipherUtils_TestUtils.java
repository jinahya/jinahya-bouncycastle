...
final class JinahyaBlockCipherUtils_TestUtils {
    ...
    static void _processBlock__(final BlockCipher cipher, final CipherParameters params) {
    ...
    static void _processAllBlocks__(final BlockCipher cipher, final CipherParameters params) throws IOException {
        final var blockSize = cipher.getBlockSize();
