...
final class JinahyaBufferedBlockCipherUtils_TestUtils {
    ...
    static void processBytesAndDoFinal__(
            final BufferedBlockCipher cipher, final CipherParameters params,
            final Function<? super CipherParameters, ? extends CipherParameters> keyParamsExtractor)
        ...
        mac.init(keyParamsExtractor.apply(params));
        // ------------------------------------------------------------------------------------------------- encrypt
