...
import io.github.jinahya.bouncycastle.miscellaneous._Camellia___TestUtils;
...
class JinahyaBlockCipherUtils_Camellia_Test {

    static Stream<Arguments> getCipherAndParamsArgumentsStream() {
        return _Camellia___TestUtils.getCipherAndParamsArgumentsStream();
    }
