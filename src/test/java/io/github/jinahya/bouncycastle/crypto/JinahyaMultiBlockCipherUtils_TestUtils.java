...
final class JinahyaMultiBlockCipherUtils_TestUtils {

    static void processBlock__(final MultiBlockCipher cipher, final CipherParameters params) {
        ...
        cipher.init(true, params);
        {
            ...
            final var outlen = JinahyaMultiBlockCipherUtils.processBlock(
                    cipher,
                    plain,
                    0,
                    out,
    ...
    static void processAllBlocks__(final MultiBlockCipher cipher, final CipherParameters params) throws IOException {
        final var blockSize = cipher.getBlockSize();
        ...
        cipher.init(true, params);
        {
            final var inbuf = new byte[ThreadLocalRandom.current().nextInt(128) + cipher.getBlockSize()];
            final var outbuf = new byte[ThreadLocalRandom.current().nextInt(128) + cipher.getBlockSize()];
            final var count = JinahyaMultiBlockCipherUtils.processAllBlocks(
                    cipher,
    ...
    private JinahyaMultiBlockCipherUtils_TestUtils() {
