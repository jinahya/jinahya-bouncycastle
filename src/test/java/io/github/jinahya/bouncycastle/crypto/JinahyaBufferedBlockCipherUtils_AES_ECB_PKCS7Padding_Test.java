...
import io.github.jinahya.bouncycastle.miscellaneous.__ECB_PKCS7Padding_TestUtils;
...
class JinahyaBufferedBlockCipherUtils_AES_ECB_PKCS7Padding_Test {

    static Stream<Arguments> getCipherAndParamsArgumentsStream() {
        return __ECB_PKCS7Padding_TestUtils.getCipherAndParamsArgumentsStream(
