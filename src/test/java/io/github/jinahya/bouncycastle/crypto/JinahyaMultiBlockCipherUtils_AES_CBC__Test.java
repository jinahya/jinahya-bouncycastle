...
import io.github.jinahya.bouncycastle.miscellaneous.__CBC__TestUtils;
...
class JinahyaMultiBlockCipherUtils_AES_CBC__Test {

    static Stream<Arguments> getCipherAndParamsArgumentsStream() {
        return __CBC__TestUtils.getCipherAndParamsArgumentsStream(
