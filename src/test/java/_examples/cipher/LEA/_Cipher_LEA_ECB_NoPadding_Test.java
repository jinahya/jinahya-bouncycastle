...
@Disabled
@DisplayName(_Cipher_LEA___Test.ALGORITHM + '/' + _Cipher_LEA_ECB__Test.MODE + "NoPadding")
@NoArgsConstructor(access = AccessLevel.PACKAGE)
@Slf4j
@SuppressWarnings({
        "java:S3577" // Test classes should comply with a naming convention
})
class _Cipher_LEA_ECB_NoPadding_Test
        extends _Cipher_LEA_ECB__Test {
